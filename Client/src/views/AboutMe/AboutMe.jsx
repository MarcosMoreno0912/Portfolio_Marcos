				...
				<div className={style.macbook}>
  				<div className={style.inner}>
    				<div className={style.screen}>
          			...
          			<div className={style.key}></div>
          			<div className={style.key}></div>
          			<div className={style.keyspace}></div>
          			<div className={style.key}></div>
          			<div className={style.key}></div>
          			<div className={style.key}></div>
          			<div className={style.key}></div>
      			...
      			<div className={style.padone}></div>
      			<div className={style.padtwo}></div>
     				<div className={style.padthree}></div>
      			<div className={style.padfour}></div>
    			</div>
  			</div>
